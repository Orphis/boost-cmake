function(_add_boost_test)
  ...
  while(${arg_start} LESS ${arg_len})
    ...
    if(test_command STREQUAL "RUN")
      ...
      if(BOOSTTEST_DEFINE)
        target_compile_definitions(${test_name} PRIVATE ${BOOSTTEST_DEFINE})
      endif()
      if(BOOSTTEST_INCLUDE)
        target_include_directories(${test_name} PRIVATE ${BOOSTTEST_INCLUDE})
      endif()
      if(BOOSTTEST_LINK)
        target_link_libraries(${test_name} PRIVATE ${BOOSTTEST_LINK})
      endif()
    else()
